...
exports.accountUtxos = exports.addressUtxos = exports.accountSpendableUtxos = exports.addressBalance = exports.accountBalance = void 0;
...
const accountSpendableUtxos = async ({ account, provider, spendAmount, }) => {
    ...
    for (let i = 0; i < account.spendStrategy.addressOrder.length; i++) {
        const address = account[account.spendStrategy.addressOrder[i]].address;
        const { spendableTotalBalance: addressTotal, spendableUtxos: formattedUtxos, } = await (0, exports.addressUtxos)({
            address,
            provider,
