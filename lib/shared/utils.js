...
const createProtoBurnScript = ({ runes, protocolTag, pointer, }) => {
    const runestone = (0, exports.encodeProtoburn)({
        runes,
        protocolTag,
        pointer,
    });
...
exports.createProtoBurnScript = createProtoBurnScript;
const encodeProtoburn = ({ runes, protocolTag, pointer, }) => {
