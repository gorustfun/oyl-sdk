...
class Provider {
    ...
    networkType;
    url;
    constructor({ url, projectId, network, networkType, version = 'v1', apiProvider, metashrewRpcUrl, // Add this parameter
     }) {
        let isTestnet;
        let isRegtest;
        switch (network) {
        ...
        this.alkanes = new alkanes_1.AlkanesRpc(masterUrl, metashrewRpcUrl); // Pass metashrewRpcUrl
